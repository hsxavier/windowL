...
memory allocation.
Code written by Henrique S. Xavier 
Last edition around 13/08/2015 at UCL, London.
...
const int NR_END=1;
// Numerical Recipes functions for creating and destroying arrays and matrices:
